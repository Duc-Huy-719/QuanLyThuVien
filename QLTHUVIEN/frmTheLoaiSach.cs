        ...
        private void sua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               /// sua.Text = "Cập nhật";
                ...
                else if (t.thucthidulieu("update  TheLoai set TenTL=N'" + txttentheloai.Text + "'where MaTL=N'" + txtmatheloai.Text + "'") == true)
                {
            ...
            if (xoa.Text == "hủy") {
                ...
                if (chon == DialogResult.Yes) {
                    try
                    {
                        ...
                        t.thucthidulieu("delete from Theloai where MaTL='" + txtmatheloai.Text+"'");
