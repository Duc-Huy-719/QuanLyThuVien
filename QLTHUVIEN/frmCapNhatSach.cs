    ...
    public partial class frmCapNhatSach : Form
    {
        ...
        private void sua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (t.thucthidulieu("update  Sach set TenSach=N'" + txttensach.Text + "', NamXB=N'" + txtnamxb.Text + "', MaNXB='" + comnhaxb.Text + "', MaTL='" + comtheloai.Text + "', MaTG='" + commatacgia.Text + "'where MaSach=N'" + txtmasach.Text + "'") == true)
                {
