    ...
    public partial class frmDocGia : Form
    {
        ...
        private void sua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (t.thucthidulieu("update  DocGia set TenDG=N'" + txttendocgia.Text + "', NgaySinh=N'" + ngayhh + "', GioiTinh=N'" + comgioitinh.Text + "', Lop='" + txtlop.Text + "'where MaDG=N'" + txtmadocgia.Text + "'") == true)
                {
