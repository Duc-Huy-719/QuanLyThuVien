...
namespace WindowsFormsApplication1
{
    public partial class Formnhaxb : Form
    {
        ...
        private void luu_Click(object sender, EventArgs e)
        {
            ...
            else if (t.thucthidulieu("INSERT INTO NhaXuatBan VALUES (N'" + txtmanhaxb.Text + "','" + txttennhaxb.Text + "','" + txtdiachi.Text + "','" + txtphone.Text +  "')") == true)
            {
            ...
            else
            {
                ...
                if (chon == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        if (t.thucthidulieu("delete from NhaXuatBan where MaNXB='" + txtmanhaxb.Text + "'")==true)
        ...
        private void txtmanhaxb_TextChanged(object sender, EventArgs e)
        {
