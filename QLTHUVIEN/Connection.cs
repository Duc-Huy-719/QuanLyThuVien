...
namespace WindowsFormsApplication1
{
    class Connection
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-HAE4MDH\DUCHUY;Initial Catalog=QLyThuVien;Integrated Security=True");//biến con sqlconection để kêt nối đến CSDL
