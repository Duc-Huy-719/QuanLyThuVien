...
namespace WindowsFormsApplication1
{
    public partial class frmMuonTra : Form
    {
        ...
        Connection t = new Connection(); public int dem;
        ...
        private void luu1_Click(object sender, EventArgs e)
        {
            ...
            day = time.Days;
            DataTable dt = t.docdulieu("select * from ChiTietPhieuMuon where MaSach= N'" + commasach.Text+ "'");
            ...
            else if (t.thucthidulieu("INSERT INTO ChiTietPhieuMuon VALUES (N'" + commaphieumuon.SelectedValue.ToString() + "','" + commasach.SelectedValue.ToString() + "','" + ngayhh + "','" + ngayhhh + "','" + ghichu.Text + "')") == true)
            {
        ...
        private void sua1_Click(object sender, EventArgs e)
        {
            ...
            else if (t.thucthidulieu("update  ChiTietPhieuMuon set NgayHenTra=N'" + ngayhhh + "'where MaSach=N'" + commasach.Text + "'") == true)
                {
